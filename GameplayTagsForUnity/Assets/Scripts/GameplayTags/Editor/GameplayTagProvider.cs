		...
		public static SettingsProvider CreateRLSettingsProvider()
		{
			...
			var provider = new SettingsProvider("Project/Gameplay Tags", SettingsScope.Project)
			{
				...
				guiHandler = (searchContext) =>
				{
					...
					{
						var deserializedSettings = GameplayTagSettings.GetOrCreateSettings();
						deserializedSettings.SortGameplayTags();
						deserializedSettings.CompileGameplayTags();
					}
				},
